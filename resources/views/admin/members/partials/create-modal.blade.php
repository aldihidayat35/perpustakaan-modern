<div class="modal fade" id="modal-add-member" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-900px">
        <div class="modal-content">
            ...
            <form class="form" method="POST" action="{{ route('admin.members.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    {{-- Photo Upload ─────────────────────────────────────── --}}
                    <div class="d-flex align-items-start gap-4 mb-5">
                        <div class="photo-preview-container text-center">
                            <div class="photo-upload-box" id="add-photo-preview"
                                ...
                                <span style="font-family:'Fredoka One',cursive; font-size:0.68rem; color:#aaa; margin-top:4px;">Pasang Foto</span>
                            </div>
                            <input type="file" name="photo" id="add-photo-input" accept="image/*" style="display:none;"
                                onchange="previewPhoto(this, 'add-photo-preview', 'add-photo-remove-wrap')"/>
                            <div id="add-photo-remove-wrap" style="display:none; margin-top:6px;">
                                <button type="button" class="btn btn-sm" style="background:var(--comic-red); color:#fff; border-radius:0; border:2px solid var(--comic-dark); box-shadow:2px 2px 0 var(--comic-dark); font-family:'Fredoka One',cursive; font-size:0.68rem;"
                                    onclick="removePhoto('add-photo-input', 'add-photo-preview', 'add-photo-remove-wrap')">
                                    🗑 Hapus
                                </button>
                            </div>
                        ...
                        <div style="flex:1;">
                            ...
                            <p style="font-size:0.78rem; color:#888; margin-bottom:8px;">
                                Pasang foto anggota untuk kartu ID. Ukuran disarankan <strong>3x4 cm</strong> atau rasio serupa.
                                Foto akan di-resize otomatis menjadi <strong>600x600 px</strong>.
                            </p>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-comic">
                        <i class="ki-duotone ki-plus fs-2"></i> Simpan Anggota
                    </button>
                </div>
            </form>
        </div>
